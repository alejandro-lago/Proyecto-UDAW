        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetMuscles = table.Column<List<string>>(type: "text[]", nullable: false),
                    SecondaryMuscles = table.Column<List<string>>(type: "text[]", nullable: false),
                    Equipments = table.Column<List<string>>(type: "text[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderInRoutine = table.Column<int>(type: "integer", nullable: false),
                    Sets = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    Reps = table.Column<string>(type: "text", nullable: false, defaultValue: "10"),
                    RestTimeSeconds = table.Column<int>(type: "integer", nullable: false, defaultValue: 60),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DayOfWeeks_Name",
                table: "DayOfWeeks",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Exercises_ExternalApiId",
                table: "Exercises",
